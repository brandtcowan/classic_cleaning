...
if ($_SERVER['REQUEST_METHOD']=="POST"){
   ...
   $email_to="brandtcowan89@gmail.com"; // Change to your email
   ...
   // validation expected data exists
	...
	$message .=  "Driver License ".clean_string($field_2)."\n";

	$message .=  "[Town/City] ".clean_string($field_3)."\n";

	$message .=  "[State] ".clean_string($field_4)."\n";
    ...
    $message .= "[Comment] ".clean_string($field_14)."\n";
   ...
   @mail($email_to, $subject, $message, $headers);
      header('Location: www.classiccleaningbymoms.com'); // your custom redirect after submit, replace redirect.html with full path i.e. http://www.yourdomain.com/redirect.html
...
?>
            ...
            <?php } ?>
                ...
                Thank you!
                <br> Your submission has been sent.
